...
public class A1 {
	...
	public static void main(String[] args) throws ParseException {
		...
		do {
			...
			while (idade < 18) {
				System.out.println("O beneficiario deve ter mais de 18 anos");
				System.out.println("Digite sua data de nascimento (Ex.: dd/MM/yyyy): ");
				data_nascimento = recebeTexto();
			...
			numeroCategoria = teclado.nextInt();
			...
			System.out.println("A catecogira selecionada é: " + categoria);
			...
			if (categoria.equalsIgnoreCase("Empregador")) {
				...
				valorTotalBeneficio += valorBeneficio * 7;
			}
			if (!categoria.equalsIgnoreCase("Empregador") && !categoria.equalsIgnoreCase("Desempregado")) {
				System.out.println("O seu beneficio será de " + quantidadeMesesBeneficio  + " meses, no valor total de de R$: " + (quantidadeMesesBeneficio * valorBeneficio));
				valorTotalBeneficio += valorBeneficio * quantidadeMesesBeneficio;
			}
			if (UF.equalsIgnoreCase("SC")) {
				System.out.println("O benefício de pessoas que moram em Santa Catarina terá acréscimo de 5%.");
			}
			if (UF.equalsIgnoreCase("SP")) {
				System.out.println("O benefício de pessoas que moram em São Paulo terá acréscimo de 10%.");
			}
			if (UF.equalsIgnoreCase("MG")) {
				System.out.println("O benefício de pessoas que moram em Minas Gerais terá acréscimo de 8%.");
			}

			desempregado(categoria, valorBeneficio);
			empregador(categoria, numeroDeFuncionarios, valorBeneficio);

			if (!UF.equalsIgnoreCase("SC") && !UF.equalsIgnoreCase("SP") && !UF.equalsIgnoreCase("MG")) {
				if (quantidadeMesesBeneficio != 7) {
	...
	public static void ranking(double valorBeneficio, String nome_completo, String categoria) {
		...
		if (RankingBeneficioUm < valorBeneficio && RankingBeneficioZero > valorBeneficio || RankingBeneficioUm == 0.00
				|| RankingBeneficioUm == RankingBeneficioZero) {
		...
		if (RankingTempoUm < quantidadeMesesBeneficio && RankingTempoZero > quantidadeMesesBeneficio
				|| RankingTempoUm == 0 || RankingTempoUm == RankingTempoZero) {
	...
	public static void desempregado(String categoria, double valorAuxilio) {
		if (categoria.equalsIgnoreCase("Desempregado")) {
			...
			valorTotalBeneficio += valorAuxilio * 6;
		}
	}
	...
	public static double calculoAuxilioBase(String categoria, int quantidadeFuncionario, boolean desempregado) {
		...
		if (desempregado && categoria.equalsIgnoreCase("desempregado")) {
	 ...
	 */
	public static int calculaIdade(String data_nascimento) throws ParseException {
		...
		nascimento.setTime(dateNascimento);
